...
const Withdraw = () => {
  ...
  const URI = "/transaction/withdraw";
  ...
  const [TName, setTName] = useState("Withdraw");
  ...
  return (
    <div className="">
      ...
      <div className="flex justify-between gap-2">
        ...
        <div className="sideNav bg-overlay w-[20%] pt-2 flex-1 md:block hidden">
          <ul className="text-center">
            <Link to={"/dashboard"}>
        ...
        <div className="wjjj pt-5 md:w-[85%] w-[100%] px-2">
          <h2 className="mx-10 mt-10 text-2xl font-bold text-center py-5">
            Withdraw <span className="text-btn">Money</span>
          </h2>
